<template>
  <div class="ghibliScene">
    <SceneSection id="Ghibli">
      <TextBlock>
        <p>
          This portfolio is inspired on movies
          <span class="-big -purple">
            of Studio Ghibli, pixels, and other designs
          </span>
          which it helps me to get an idea to build.
        </p>
      </TextBlock>
    ...
    <SceneSection id="Ghibli3">
      <TextBlock>
        <p class="-big">
          currently studying
          <span class="-purple"
            >MERN Stack and other programming language which is in demand.</span
          >
        </p>
        <p>
