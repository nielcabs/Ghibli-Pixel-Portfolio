<template>
  <div class="bizScene">
    <TitleSection scene="bizTitle">
      <TitleFunction params="2023,Present">Ardent Digital Solution</TitleFunction>
    </TitleSection>

    <SceneSection id="biz1">
      <TextBlock>
        <p class="-big">
          From 2023 to Present I was
          <strong class="-purple">Web Designer</strong>
          @
          <a
            href="https://ardentdigitalsolutions.com/"
            target="_blank"
            title="Visit Ardent Digital Solution's website"
          >
            ADS</a
          >.
        </p>
        <p>
           Offers the simplest & easiest way for you to manage your growing projects & business needs.
        </p>
      </TextBlock>
      <template #container>
